    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                ...
                lang = options.language || self.data('language') || $.fn.fileinput.defaults.language || 'id', opt;
            if (!data) {
                if (theme) {
                    t = $.fn.fileinputThemes[theme] || {};
                }
                if (lang !== 'id' && !$h.isEmpty($.fn.fileinputLocales[lang])) {
