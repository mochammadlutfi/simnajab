...
class AngDrainase extends Model
{
    protected $table = 'penganggaran_drainase';
     ...
     */
    protected $fillable = [
        'drainase_id', 'penganggaran_id', 'panjang', 'patok_awal', 'patok_akhir', 'lat_awal', 'lng_awal', 'lat_akhir', 'lng_akhir', 'polypath'
    ];
