...
class MapBeton
{
    ...
    public static function penganggaran($jalan_id, $beton_id)
	{
        $beton = Beton::find($beton_id);
        // dd($tpt);
        ...
        $marker['infowindow_content'] = 'Titik Awal Flat Beton';
        $gmap->add_marker($marker);

        $marker = array();
        $marker['position'] = $beton->lat_akhir.', '.$beton->lng_akhir;
        $marker['draggable'] = true;
        ...
        $marker['infowindow_content'] = 'Titik Akhir Flat Beton';
        $gmap->add_marker($marker);
