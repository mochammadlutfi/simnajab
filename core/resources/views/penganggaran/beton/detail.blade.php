                    ...
                    <table class="table font-weight-bold">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="mr-5">:</span>
                                    @if($penganggaran->tujuan == 'Pembangunan')
                                        {{ $penganggaran->beton->panjang }} Meter
                                    @else
                                        {{ $penganggaran->AngBeton->panjang }} Meter
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><span class="mr-5">:</span>
                                    @if($penganggaran->tujuan == 'Pembangunan')
                                    {{ $penganggaran->beton->patok_awal }} Meter
                                    @else
                                    {{ $penganggaran->AngBeton->patok_awal }} Meter
                                    @endif
                                </td>
                            </tr>
                            <tr style="border-bottom: 1px solid #e4e7ed;">
                                ...
                                <td><span class="mr-5">:</span>
                                    @if($penganggaran->tujuan == 'Pembangunan')
                                    {{ $penganggaran->beton->patok_akhir }} Meter
                                    @else
                                    {{ $penganggaran->AngBeton->patok_akhir }} Meter
                                    @endif
                                </td>
                            </tr>
                            <tr >
