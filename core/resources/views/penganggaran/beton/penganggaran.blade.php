...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">{{ $step2['tujuan'] }} Flat Beton {{ $jalan->nama }}</span>
    </nav>
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">{{ $step2['tujuan'] }} Flat Beton <small>{{ $jalan->nama }}</small></h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-panjang" name="panjang" placeholder="Panjang" readonly>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-patok_awal" name="patok_awal" placeholder="Patok Awal" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                Meter
                                            </span>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-patok_akhir" name="patok_akhir" placeholder="Patok Awal" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                Meter
                                            </span>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.fail == false) {
                    ...
                    swal({
                        title: "Berhasil",
                        text: "Penganggaran Flat Beton Berhasil Disimpan",
                        timer: 3000,
                        buttons: false,
                        icon: 'success'
                    });
...
{!! $map['js'] !!}
<script>
    var start_jalan = new google.maps.LatLng('{{ $beton->lat_awal }}', '{{ $beton->lng_awal }}');
</script>
@endpush
