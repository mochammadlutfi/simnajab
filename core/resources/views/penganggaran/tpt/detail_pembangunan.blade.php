            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <label class="col-8">: {{ $penganggaran->tpt->panjang }} Meter</label>
                    </div>
                    <div class="row">
                        <label class="col-4">Patok Awal</label>
                        <label class="col-8">: {{ $penganggaran->tpt->patok_awal }} Meter</label>
                    </div>
                    <div class="row">
                        <label class="col-4">Patok Akhir</label>
                        <label class="col-8">: {{ $penganggaran->tpt->patok_akhir }} Meter</label>
                    </div>
