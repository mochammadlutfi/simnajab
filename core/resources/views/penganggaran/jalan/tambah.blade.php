                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="col-form-label">Panjang {{ $step2['tujuan'] }}</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-panjang" name="panjang" placeholder="Panjang {{ $step2['tujuan'] }}" readonly>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-patok_awal" name="patok_awal" placeholder="Patok Awal {{ $step2['tujuan'] }}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                Meter
                                            </span>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-patok_akhir" name="patok_akhir" placeholder="Patok Awal {{ $step2['tujuan'] }}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                Meter
                                            </span>
