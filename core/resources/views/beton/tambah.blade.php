...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">Tambah Data Beton</span>
    </nav>
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Tambah Data Beton <small>{{ $jalan->nama }}</small></h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="col-form-label">Panjang Beton</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="field-panjang" name="panjang" placeholder="Masukan Panjang Beton">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.fail == false) {
                    ...
                    swal({
                        title: "Berhasil",
                        text: "Data Flat Beton Jalan Berhasil Disimpan",
                        timer: 3000,
                        buttons: false,
                        icon: 'success'
                    });
